...
public class MainActivity extends BaseActivity
    ...
    public static final String SIGN_IN = "Please sign in.";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (mAuth.getCurrentUser() == null) {
            Toast.makeText(this, SIGN_IN, Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            for (int i = 0; i < 5; i++) menu.getItem(i).setEnabled(true);
            ...
            for (int i = 0; i < 5; i++) menu.getItem(i).setEnabled(false);
    ...
    public void initFab() {
        ...
        if (fragment instanceof ContactsFragment) {
            ...
            else Toast.makeText(this, SIGN_IN, Toast.LENGTH_SHORT).show();
