...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.ViewHolder> implements Filterable {
    ...
    final class ViewHolder extends RecyclerView.ViewHolder
        ...
        void bind(Contact contact) {
            ...
            mQuery = mContact.getQuery();
            mAddress = mContact.getAddress();
            mNotes = mContact.getNotes();
        ...
        public void onClick(View view) {
            ...
            query = detailDialog.findViewById(R.id.popupQuery);
            address = detailDialog.findViewById(R.id.popupAddress);
            notes = detailDialog.findViewById(R.id.popupNotes);
            ...
            btnEdit.setOnClickListener(view14 -> {
            ...
            btnCall.setOnClickListener(view12 -> {
